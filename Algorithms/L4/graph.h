...
public:
    ...
    int FordFalkerson(); //Один шаг алгоритма Форда-Беллмана
    void FordFalkersonInit(); //Инициализация алгоритма
    void FordFalkersonReset(); //Сброс алгоритма
